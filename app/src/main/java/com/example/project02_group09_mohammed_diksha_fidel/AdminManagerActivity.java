...
public class AdminManagerActivity extends AppCompatActivity {
    ...
    // Declaration for your original navigation button (if it exists in the layout)
    private Button buttonViewChallenges;
    ...
    private void initViews() {
        ...
        // Find the view challenges button if it's in the layout
        buttonViewChallenges = findViewById(R.id.btnViewChallenges);
    }
    ...
    private void setupListeners() {
        ...
        // CRITICAL FIX: Add back the listener for the Challenges screen from your original branch
        if (buttonViewChallenges != null) {
            buttonViewChallenges.setOnClickListener(v -> {
