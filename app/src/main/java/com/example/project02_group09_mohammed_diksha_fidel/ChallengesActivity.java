...
import androidx.core.graphics.Insets; // Import the correct Insets class
...
public class ChallengesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // CRITICAL FIX: Combine UI padding and initialization logic
        // This is necessary because both branches modified onCreate
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.activity_challenges), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        // Database and Session setup (Teammate's logic)
